...
# Copy config files from /tmp (SCP'd earlier)
cp /tmp/init-db.sql .
...
services:
  ...
  gateway:
    image: us-central1-docker.pkg.dev/workflow-platform-demo/wfp-images/gateway:latest
    ports:
      - "9080:8080"
    environment:
  ...
  workflow-service:
    image: us-central1-docker.pkg.dev/workflow-platform-demo/wfp-images/workflow-service:latest
    environment:
  ...
  custom-fields-service:
    image: us-central1-docker.pkg.dev/workflow-platform-demo/wfp-images/custom-fields-service:latest
    environment:
  ...
  notification-service:
    image: us-central1-docker.pkg.dev/workflow-platform-demo/wfp-images/notification-service:latest
    environment:
  ...
  audit-service:
    image: us-central1-docker.pkg.dev/workflow-platform-demo/wfp-images/audit-service:latest
    environment:
  ...
  admin-portal:
    image: us-central1-docker.pkg.dev/workflow-platform-demo/wfp-images/admin-portal:latest
    ports:
      - "5173:80"
    depends_on:
      - gateway
  ...
  user-portal:
    image: us-central1-docker.pkg.dev/workflow-platform-demo/wfp-images/user-portal:latest
    ports:
      - "5174:80"
    depends_on:
      - gateway
